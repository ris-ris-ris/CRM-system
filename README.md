...
Веб‑CRM система для ведения клиентской базы, сделок и задач с воронкой продаж (Kanban), заметками, файлами и встроенным диалогом по сделке (email + синхронизация входящих). Проект реализован на Laravel и ориентирован на быстрый старт и дальнейшее расширение.
...
- **Воронка (Kanban)**: перенос сделок по стадиям с подтверждением и быстрым обновлением
...
- **Диалог по сделке (Email)**: исходящие письма, сохранение истории, синхронизация входящих через IMAP
