...
<body>
    ...
    <div class="form-container">
        <div class="form-box">
            ...
            <p class="text-center text-gray-300 mb-8 text-sm">Регистрация</p>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-5">
                    ...
                    <input id="name" class="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" type="text" name="name" value="{{ old('name') }}" required autofocus placeholder="Ваше имя" style="color: #ffffff !important; background-color: rgba(255, 255, 255, 0.1) !important;">
                    <x-input-error :messages="$errors->get('name')" class="mt-2" />
                </div>
                
                <div class="mb-5">
                    <label for="email" class="block text-sm font-medium text-gray-300 mb-2">Email</label>
                    <input id="email" class="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" type="email" name="email" value="{{ old('email') }}" required placeholder="your@email.com" style="color: #ffffff !important; background-color: rgba(255, 255, 255, 0.1) !important;">
                ...
                <div class="mb-6">
                    ...
                    <input id="password_confirmation" class="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" type="password" name="password_confirmation" required placeholder="••••••••" style="color: #ffffff !important; background-color: rgba(255, 255, 255, 0.1) !important;">
                </div>
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('login') }}" class="text-sm text-blue-400 hover:text-blue-300 transition">Уже зарегистрированы? Войти</a>
            </div>
        </div>
    </div>
</body>
